                  ...
                  <table className="w-full">
                    ...
                    <tbody>
                      ...
                      {products.map((item, index) => (
                        ...
                        <tr key={index} className="text-center text-black font-medium border-b border-gray-200">
                    ...
                    <div className="flex gap-2 mb-6">
                      ...
                      {otp.map((digit, index) => (
                        ...
                        <input
                          ...
                          className="w-12 h-12 text-center border border-gray-300 rounded-md text-lg focus:outline-none"
                        />
