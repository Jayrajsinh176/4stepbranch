...
function PurchaseBalanceRequest() {
  ...
  const handleSubmit = async (Purchase) => {
    ...
    formData.append("type", Purchase); // purchase or turnover
    ...
    try {
      ...
      await axios.post(
        "http://127.0.0.1:8000/api/balance-request",
        formData,
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full border border-gray-400  rounded-lg text-gray-600 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#B0422E]">
...
export default PurchaseBalanceRequest;