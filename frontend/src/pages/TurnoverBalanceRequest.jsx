...
function TurnoverBalance() {
  ...
  const handleSubmit = async (Turnover) => {
    ...
    formData.append("type", Turnover); // purchase or turnover
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full border  border-gray-400 text-gray-600 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#B0422E]">
